...
function plot_biomes(m::KoppenModel, filename::String, output_file::String)
    ...
    biome_names = [ 
        ...
        "Equatorial winter dry (Aw)", "Cold desert (BWk)", "Hot desert (BWh)",
        "Cold steppe (BSk)", "Hot steppe (BSh)", "Warm temperate fully humid hot summer (Cfa)",
...
# Example usage
filename = "/Users/capucinelechartre/Documents/DocumentsWSLM29592/PhD/BIOME/output_Koppen.nc"
output_file = "/Users/capucinelechartre/Documents/DocumentsWSLM29592/PhD/BIOME/output_Koppen.svg"
