# Abstract type - no fields allowed
abstract type AbstractPFTCharacteristics end # this should be defined in your root folder
abstract type AbstractPFT end
abstract type AbstractBiomeClassification end

module BIOME4
    using Main: AbstractPFTCharacteristics, AbstractPFT, AbstractBiomeClassification # TOFIX: instead, should be using: Biome: AbstractPFTCharacteristics, AbstractPFT, AbstractBiomeClassification

    struct Characteristics{T <: Real, U <: Int} <: AbstractPFTCharacteristics
        name::String
        phenological_type::U
    ...
    struct BiomeClassification <: AbstractBiomeClassification
        biome_list::Vector{AbstractPFT}
    end
    ...
    BiomeClassification() = BiomeClassification([WoodyDesert(),
                                                ...
                                                C4TropicalGrass(),
                                                ColdHerbaceous()
     ]) # place all other Biome4 PFTs here

end

import .BIOME4
biome4classification = BIOME4.BiomeClassification()
